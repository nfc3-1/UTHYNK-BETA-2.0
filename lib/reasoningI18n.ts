...
export const uiCopy = {
  en: {
    ...
    claim: "Claim",
    claimEvaluation: "Claim Evaluation",
    ...
    reasoningStepTwo: "What supports it?",
    reasoningStepThree: "Strongest challenge",
    reasoningStepFour: "What did UThynk learn?",
  ...
  es: {
    ...
    claim: "Afirmación",
    claimEvaluation: "Evaluacion de afirmacion",
    ...
    reasoningStepFour: "Que aprendio UThynk?",
  ...
  fr: {
    ...
    categoryTab: "Categories",
    claim: "Thèse",
    claimEvaluation: "Evaluation de these",
    ...
    reasoningStepFour: "Ce qu'UThynk apprend",
